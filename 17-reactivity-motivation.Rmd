...
La idea inicial de cómo funciona Shiny es que es "magia". Aunque la magia es
de gran ayuda al principio dado que te permite crear aplicaciones de forma
muy rápida, puede llevar a desilusión a lo largo del camino; sin un modelo mental solido,
se puede volver difícil predecir el comportamiento del software a medida que aumenta
la complejidad del mismo.

Afortunadamente, la magia de Shiny es "buena" magia. Como dijo Tom Dale sobre
su librería Ember.js, una librería de JavaScript para la creación de aplicaciones
web, "Hacemos mucha magia, pero es **buena magia**, lo que significa que se
compone de los mismos principios." Esta es la calidad que el equipo de Shiny aspira
para Shiny, especialmente cuando se trata de programación reactiva.
A medida que se explora la programación reactiva con más profundidad,
encontrarás un sistema inteligente e ingenioso pero consistente y sencillo.
Una vez se tenga un modelo mental preciso sobre la reactividad, entenderás
que la magia se deriva de combinar conceptos de forma consistente.

En este capítulo mostraremos el poder de la programación reactiva intentando
resolver problemas sin ella y contando una breve historia sobre la reactivadad
en relación a Shiny.

## ¿Por qué necesitamos a la programación reactiva? {#motivation}
